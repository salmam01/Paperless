...
public class DocumentRepositoryTests
{
    ...
    public async Task Insert_And_Get_By_Id_Works()
    {
        ...
        await repo.AddDocumentAsync(entity);
    ...
    public async Task GetAllDocuments_Works()
    {
        ...
        await repo.AddDocumentAsync(new DocumentEntity { Id = Guid.NewGuid(), Name = "Doc1", Content = "Content1", Summary = "Summary1", FilePath = "f1", CreationDate = DateTime.UtcNow, Type = "txt", Size = 1 });
        await repo.AddDocumentAsync(new DocumentEntity { Id = Guid.NewGuid(), Name = "Doc2", Content = "Content2", Summary = "Summary2", FilePath = "f2", CreationDate = DateTime.UtcNow, Type = "pdf", Size = 2 });
